...
const treeData = {
  ...
  subtropical_high: {
    ...
    label: "亜熱帯高圧帯",
    category: "condition",
    description: "下降気流が卓越しやすく、乾燥しやすい高圧帯です。",
  ...
  descending: {
    ...
    label: "下降気流",
    category: "process",
    description: "空気が下向きに動いて雲ができにくくなります。",
    next: ["little_rain"]
  },
  little_rain: {
    id: "little_rain",
    label: "少雨",
    category: "climate",
    description: "降水量が非常に少なく、乾燥地域が広がります。",
    next: ["bw"]
  },
  bw: {
    id: "bw",
    label: "BW",
    category: "climate",
    description: "砂漠気候。年間降水量が極めて少ない乾燥気候です。",
    next: ["desert"]
  },
  desert: {
    id: "desert",
  ...
  bs: {
    ...
    label: "BS",
    category: "climate",
    description: "ステップ気候。半乾燥で短草草原が広がる気候です。",
    next: ["steppe"]
  },
  steppe: {
    id: "steppe",
